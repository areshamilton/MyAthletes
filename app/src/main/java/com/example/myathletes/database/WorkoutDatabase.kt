...
/**
 * Manages the database that stores the Workout table and its entitites.
...
abstract class WorkoutDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: WorkoutDatabase? = null // This class
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        WorkoutDatabase::class.java, // Your database class
